export default function Navbar() {
    return (
        <nav className="fixed top-0 left-0 flex w-24 max-h-screen darkblue-700 transition overflow-hidden">
            <ul className="flex gap-6 flex-col overflow-hidden">
                <List
                    label="Dashboard"
                    icon={
                        <svg
                ...
                />
                <Collapse label="Mahasiswa" links={} icon={} />
                <Collapse label="Jadwal" links={} icon={} />
            </ul>
        </nav>
    );
}
